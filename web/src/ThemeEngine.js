...
export function ThemeProvider({ children }) {
    ...
    return (_jsx(ThemeContext.Provider, { value: { theme, setThemeId }, children: children }));
}
export function ThemeSelector() {
    const { theme, setThemeId } = useTheme();
    return (_jsxs("div", { children: [_jsx("div", { style: { fontSize: 10, fontWeight: 600, color: "var(--of-muted-text)", textTransform: "uppercase", letterSpacing: "0.8px", marginBottom: 8 }, children: "Theme" }), _jsx("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }, children: THEMES.map(t => (_jsxs("button", { onClick: () => setThemeId(t.id), style: {
                    ...
                    }, children: [_jsx("div", { style: { display: "flex", gap: 4, marginBottom: 6 }, children: t.swatch.map((c, i) => (_jsx("div", { style: { width: 16, height: 16, borderRadius: 4, background: c, border: "1px solid rgba(255,255,255,0.1)" } }, i))) }), _jsx("div", { style: { fontSize: 11, fontWeight: 600, color: "var(--of-body-text)" }, children: t.name })] }, t.id))) })] }));
}
