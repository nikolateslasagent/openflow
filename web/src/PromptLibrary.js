...
export function PromptLibraryPanel({ onUsePrompt, onCreateNode }) {
    ...
    const inputStyle = { width: "100%", background: "#f5f5f7", border: "none", borderRadius: 8, fontSize: 12, padding: "8px 12px", outline: "none", boxSizing: "border-box", color: "#1a1a1a" };
    return (_jsxs("div", { style: { padding: 16, display: "flex", flexDirection: "column", height: "100%" }, children: [_jsx("div", { style: { fontSize: 13, fontWeight: 700, color: "#1a1a1a", marginBottom: 4 }, children: "\uD83D\uDCDA Prompt Library" }), _jsxs("div", { style: { fontSize: 10, color: "#9ca3af", marginBottom: 12 }, children: [PROMPTS.length, " curated prompts"] }), _jsx("input", { value: search, onChange: e => setSearch(e.target.value), placeholder: "Search prompts...", style: { ...inputStyle, marginBottom: 8 } }), _jsxs("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 8 }, children: [CATEGORIES.map(c => (_jsx("button", { onClick: () => setCategory(c), style: { padding: "4px 8px", borderRadius: 6, border: "none", background: category === c ? "#c026d3" : "#f5f5f7", color: category === c ? "#fff" : "#6b7280", fontSize: 10, fontWeight: 600, cursor: "pointer" }, children: c }, c))), _jsx("button", { onClick: () => setShowFavoritesOnly(!showFavoritesOnly), style: { padding: "4px 8px", borderRadius: 6, border: "none", background: showFavoritesOnly ? "#fbbf24" : "#f5f5f7", color: showFavoritesOnly ? "#fff" : "#6b7280", fontSize: 10, fontWeight: 600, cursor: "pointer" }, children: "\u2B50 Favorites" })] }), _jsxs("div", { style: { flex: 1, overflowY: "auto" }, children: [filtered.length === 0 && _jsx("div", { style: { fontSize: 11, color: "#9ca3af", textAlign: "center", padding: 20 }, children: "No prompts found" }), filtered.map((p, i) => (_jsxs("div", { style: { padding: "10px 12px", background: "#f9f9fb", borderRadius: 10, marginBottom: 6, cursor: "pointer", transition: "all 0.15s" }, onMouseOver: e => { e.currentTarget.style.background = "#f0f0f3"; }, onMouseOut: e => { e.currentTarget.style.background = "#f9f9fb"; }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }, children: [_jsx("div", { style: { fontSize: 12, fontWeight: 600, color: "#1a1a1a", flex: 1 }, children: p.title }), _jsx("button", { onClick: (e) => { e.stopPropagation(); setFavorites(toggleFavorite(p.title)); }, style: { background: "none", border: "none", cursor: "pointer", fontSize: 14, padding: 0, color: favorites.includes(p.title) ? "#fbbf24" : "#d1d5db" }, children: favorites.includes(p.title) ? "★" : "☆" })] }), _jsx("div", { style: { fontSize: 10, color: "#6b7280", lineHeight: 1.4, marginBottom: 6, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }, children: p.prompt }), _jsxs("div", { style: { display: "flex", gap: 4 }, children: [_jsx("button", { onClick: () => { navigator.clipboard.writeText(p.prompt); onUsePrompt(p.prompt); }, style: { padding: "3px 8px", borderRadius: 5, border: "none", background: "#c026d3", color: "#fff", fontSize: 9, fontWeight: 600, cursor: "pointer" }, children: "\uD83D\uDCCB Copy" }), onCreateNode && (_jsx("button", { onClick: () => onCreateNode(p.prompt), style: { padding: "3px 8px", borderRadius: 5, border: "none", background: "#6366f1", color: "#fff", fontSize: 9, fontWeight: 600, cursor: "pointer" }, children: "+ Node" })), _jsx("span", { style: { padding: "3px 6px", background: "#e8e8eb", borderRadius: 5, fontSize: 9, color: "#6b7280" }, children: p.category })] })] }, i)))] })] }));
}
